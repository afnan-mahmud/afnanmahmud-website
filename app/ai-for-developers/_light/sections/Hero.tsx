            ...
            <div className="mt-4 flex justify-center">
              ...
              >
                <span className="inline-flex w-full sm:w-auto items-center justify-center gap-2.5 rounded-full bg-white px-7 py-3.5 text-base font-extrabold text-[var(--ink)] transition-colors group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-slate-50">
                  ...
                  <MonitorPlay size={20} className="accent-text transition-transform duration-200 group-hover:scale-110" />
                  <span>ডেমো ক্লাস দেখুন</span>
                  <span className="rounded-full bg-[linear-gradient(135deg,#f43f5e,#ec4899)] px-2.5 py-0.5 text-xs font-black tracking-wide text-white shadow-xs">
                    ফ্রি
                  </span>
                </span>
              </Link>
