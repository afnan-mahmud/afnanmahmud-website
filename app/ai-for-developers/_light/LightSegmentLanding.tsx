...
import { ENROLLED_LABEL } from './constants';
  ...
  return (
    <EnrollProvider>
      ...
      <div className="min-h-screen overflow-x-clip pb-44 lg:pb-0" style={themeStyle(content.key)}>
        {/* ViewContent is tracked one level up, in LightLandingPage, so it also
            covers visitors who never get past the category gate. */}
