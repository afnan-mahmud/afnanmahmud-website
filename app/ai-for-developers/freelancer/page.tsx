...
import { freelancer } from '../segments/freelancer';

export const metadata: Metadata = {
  title: freelancer.meta.title,
  description: freelancer.meta.description,
  openGraph: {
    title: freelancer.meta.ogTitle,
    description: freelancer.meta.ogDescription,
    type: 'website',
  },
};
...
export default async function FreelancerLandingPage() {
  ...
  return (
    <>
      ...
      <SegmentLanding content={freelancer} enrolledLabel={enrolledLabel} />
    </>
  );
}
