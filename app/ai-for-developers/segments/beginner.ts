...
export const beginner: SegmentContent = {
  ...
  hero: {
    ...
    headlineTrail: '।',
    subheadline:
      'একদম শূন্য থেকে — কোডিং না জেনেও AI-কে গাইড করে নিজের হাতে অ্যাপ ও ওয়েবসাইট বানান।',
    bodyCopy:
  ...
  cta2: {
    ...
    sub: '৮টি মডিউল, ৪০+ লেসন, ৫টি রিয়েল প্রজেক্ট — স্টেপ বাই স্টেপ, একদম বেসিক থেকে।',
  },
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'হ্যাঁ। কোর্সে ৫টি রিয়েল প্রজেক্ট বানানো হবে হাতে-কলমে, তাই কোর্স শেষে নিজের আইডিয়া নিয়ে নিজেই ওয়েবসাইট বা মোবাইল অ্যাপ বানাতে পারবেন।',
      },
    ],
  },
};
