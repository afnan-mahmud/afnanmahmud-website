...
// Boundary for the public marketing/course pages. Without this, a thrown error
// in a server component (e.g. a DB read on the home page) bubbles to the root
// and renders an ungraceful 500.
    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ textAlign: 'center', maxWidth: 480 }}>
        ...
        <p className={inter.className} style={{ color: '#71717a', fontSize: '0.9375rem', lineHeight: 1.6, marginBottom: 32 }}>
          পেজটি লোড করতে সমস্যা হচ্ছে। একটু পরে আবার চেষ্টা করুন।
        </p>
